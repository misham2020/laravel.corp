...
<![endif]-->
    ...
    <head>
        ...
        <link rel="apple-touch-icon-precomposed" sizes="144x144" href="{{ asset('site/apple-touch-icon-144x.png') }}" />
        <!-- For first- and second-generation iPad: -->
        <link rel="apple-touch-icon-precomposed" sizes="114x114" href="{{ asset('site/apple-touch-icon-114x.png') }}" />
        <!-- For first- and second-generation iPad: -->
        <link rel="apple-touch-icon-precomposed" sizes="72x72" href="{{ asset('site/apple-touch-icon-72x.png') }}" />
        <!-- For non-Retina iPhone, iPod Touch, and Android 2.1+ devices: -->
        <link rel="apple-touch-icon-precomposed" href="{{ asset('site/apple-touch-icon-57x.png') }}" />
        <!-- [favicon] end -->
		...
		<script type="text/javascript" src="{{ asset('site') }}/js/myscripts.js"></script>
                ...
                <div id="header" class="group">
                    ...
                    <div class="group inner">
                        ...
                        <div id="logo" class="group">
                            <a href="index.html" title="Pink Rio"><img src="{{ asset('site') }}/images/logo.png" title="Pink Rio" alt="Pink Rio" /></a>
                        </div>
                        <!-- END LOGO -->
